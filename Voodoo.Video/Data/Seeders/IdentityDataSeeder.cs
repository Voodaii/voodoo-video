...
namespace Voodoo.Video.Data.Seeders
{
        ...
        where TIdentityRole : IdentityRole, new()
    {
        ...
        private const string DefaultAdminUserEmail = "admin@voodoo.com";
        ...
        {
            var user = await userManager.FindByEmailAsync("admin@voodoo.com");
            if (user == null)
            {
